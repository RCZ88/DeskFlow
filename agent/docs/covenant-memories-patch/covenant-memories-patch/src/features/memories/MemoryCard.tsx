...
// Deliberately organic sizing (span sm/lg) instead of a uniform SaaS grid --
// a real collage has varied tile sizes, which is one of the "distinctive
// element per component" moves the Taste skill calls for at variance=5-7.
