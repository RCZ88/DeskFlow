...
// Inspired directly by Apple Photos' "Memories" and 1 Second Everyday's
// "On This Day" resurfacing -- research turned up this pattern repeatedly as
// the single highest-warmth, lowest-effort feature in the category: it asks
// nothing of the user and just quietly hands back something meaningful.
