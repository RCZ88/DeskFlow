...
// A quiet daily reflective/inspirational prompt. The content source is
// pluggable (see prompts.ts) -- a verse, a quote, a question, anything the
// user configures. The default packs are intentionally generic so this
// works for anyone's practice, spiritual or otherwise.
