// Centralized, general-purpose copy bank. Kept deliberately warm but plain --
// no guilt, no red "missed" language, no exclamation-point hype. Anyone using
// this for any kind of personal practice should feel spoken to, not scored.
