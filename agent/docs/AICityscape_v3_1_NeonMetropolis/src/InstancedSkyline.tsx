/* ============================================================================
 * InstancedSkyline.tsx — v3.1. The WHOLE city in ONE InstancedMesh (1 draw call).
 * Per-instance transform (footprint + height + TANGENTIAL ROTATION), per-instance
 * neon color / emissive / hero-flag / pulse-phase. Drives the uTime uniform for
 * the GPU hero pulse. Click a tower -> onSelect.
 * ========================================================================== */
