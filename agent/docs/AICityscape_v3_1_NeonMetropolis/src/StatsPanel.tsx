/* ============================================================================
 * StatsPanel.tsx — DOM overlay card shown when a hero tower is clicked.
 * Plain React + inline styles (no UI dep). Render OUTSIDE <Canvas>, controlled
 * by the `selected` state lifted from InstancedSkyline via CityScene.
 * ========================================================================== */
