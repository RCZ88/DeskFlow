/* ============================================================================
 * HeroOverlays.tsx — v3.1. Things drawn ONLY for the few hero towers (cheap):
 *  - a neon roofline frame (additive edges -> bloom makes it glow), now rotated
 *    to match the tower's tangential orientation in the radial city
