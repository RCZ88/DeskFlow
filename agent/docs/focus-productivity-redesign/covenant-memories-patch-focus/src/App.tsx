...
import {
  ...
  X,   FolderTree, Bot, Minus, HelpCircle, Settings2, Moon, FileText, BookOpen, Wallet, GraduationCap, Activity, Smartphone,
  HeartHandshake, Images
} from 'lucide-react';
...
// Covenant (commitments/streaks) and Memories (photo/video collage) are the
// "warm corner" of the app -- lazy-loaded like OrbitSystem since neither is
// needed on first paint.
const CovenantPage = lazy(() => import('./features/covenant/CovenantPage'));
...
Trend: +14% vs. yesterday. Keep it up!`;
  ...
  const sidebarItems = [
    ...
    { icon: HeartHandshake, label: 'Covenant', path: '/covenant' },
        ...
        <div className={`flex-1 min-h-0 ${location.pathname === '/terminal' ? 'flex flex-col overflow-hidden' : 'overflow-auto p-5'}`}>
          <AnimatePresence mode="sync">
            <Routes location={location} key={location.pathname}>
              ...
              <Route path="/covenant" element={<Suspense fallback={<div className="p-5 text-zinc-500 text-sm">Loading Covenant...</div>}><CovenantPage /></Suspense>} />
              <Route path="/memories" element={<Suspense fallback={<div className="p-5 text-zinc-500 text-sm">Loading Memories...</div>}><MemoriesPage /></Suspense>} />
