...
// Combines Covenant and Memories into a single sidebar entry, following the
// exact same sticky-tab-bar pattern already used by ActivityPage.tsx (pill
// highlight via layoutId, per-tab accent color, AnimatePresence crossfade) --
// so this reads as "how DeskFlow does tabs", not a bespoke one-off. Reduces
// two sidebar rows to one, as requested.
const TABS = [
...
export default function LifePage() {
  ...
  return (
    <div className="flex flex-col h-full" data-page={activeTab}>
      {/* Sticky tab bar -- same shape as ActivityPage's Applications/Websites/Productivity bar */}
