...
// Life (Covenant + Memories combined) is the "warm corner" of the app --
// lazy-loaded like OrbitSystem since it isn't needed on first paint. Both
// features live inside one page/one sidebar entry as tabs.
        ...
        <div className={`flex-1 min-h-0 ${location.pathname === '/terminal' ? 'flex flex-col overflow-hidden' : 'overflow-auto p-5'}`}>
          <AnimatePresence mode="sync">
            <Routes location={location} key={location.pathname}>
              ...
              <Route path="/life" element={<Suspense fallback={<div className="p-5 text-zinc-500 text-sm">Loading...</div>}><LifePage /></Suspense>} />
              <Route path="/covenant" element={<Navigate to="/life?tab=covenant" replace />} />
              <Route path="/memories" element={<Navigate to="/life?tab=memories" replace />} />
