...
// FocusSection is a named export, not a default -- wrap it so it can still be
// lazy-loaded like the other tabs (it pulls in Chart.js for the weekly trend
// chart, worth deferring until the tab is actually opened).
