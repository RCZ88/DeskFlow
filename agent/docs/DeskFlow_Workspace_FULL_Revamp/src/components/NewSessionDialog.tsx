      ...
      <div className="bg-zinc-900/95 backdrop-blur-xl rounded-xl p-5 w-full max-w-lg max-h-[85vh] overflow-y-auto border border-zinc-700/50 shadow-black/40" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mb-4">
          ...
          <select
            ...
            className="w-full bg-zinc-900/60 border border-zinc-800 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-zinc-600/60 focus:border-zinc-600 transition-colors duration-150"
          >
        ...
        <div className="mb-4">
          ...
          {terminalMode === 'select' && (
            <select
              ...
              className="w-full mt-2 bg-zinc-900/60 border border-zinc-800 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-zinc-600/60 focus:border-zinc-600 transition-colors duration-150"
            >
            ...
            <div>
              ...
              <div className={`mb-3 ${resumeSessionId ? 'opacity-40' : ''}`}>
                ...
                <select
                  ...
                  disabled={!!resumeSessionId}
                  className="w-full bg-zinc-900/60 border border-zinc-800 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-zinc-600/60 focus:border-zinc-600 transition-colors duration-150 disabled:cursor-not-allowed disabled:opacity-50"
                >
