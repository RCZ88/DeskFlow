...
// Signature moment #1: the "grace-reset" transition.
// This is the emotional core of the module. When a streak breaks, most habit
// apps show a snapped chain, a red X, or a dead flame -- a punishment beat.
// This does the opposite: a warm light gathers, breathes once, and settles
// back into a calm state, paired with copy that treats the reset as neutral
// information, not a failure. It reads as relief, not loss.
