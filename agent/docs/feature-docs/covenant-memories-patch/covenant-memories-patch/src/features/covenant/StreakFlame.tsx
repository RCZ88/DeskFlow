...
// A breathing, glowing flame that grows a little warmer and steadier the
// longer the streak runs -- but never turns into a red X or a cracked
// icon when the streak is 0. Zero just looks calm, not broken.
