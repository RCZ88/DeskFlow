...
// Default, non-denominational, general-purpose reflective/inspirational prompt
// packs. Anyone can add their own pack (a verse, a quote, a question, a line
// from a book that matters to them) through addPromptPack() below -- nothing
// here is tailored to one person's situation.
...
// Deterministic "prompt of the day": same prompt all day, changes daily,
// no server round-trip, no randomness that would flicker on re-render.
