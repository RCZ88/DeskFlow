...
import { BookOpen, ChevronLeft, Import, BarChart3, FileUp, FileCode2, HelpCircle, Download, CheckCircle2, AlertCircle, Loader2, Keyboard } from 'lucide-react';
...
import type { LessonSummary, LessonWithNodes, RenderableNode, TutorAnswer, Result, ValidationIssue, MasteryLevel, NodeProgress } from '../../shared/learn/types';
