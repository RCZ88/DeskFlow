...
// Redesigned to match the same visual language as the full Deep Focus
// experience (Activity -> Focus tab): real circular progress instead of bare
// digits, NumberTicker for the countdown, a proper status Badge, and
// outcome-colored history rows instead of plain text -- while staying
// compact enough for its 1/3-width dashboard slot.
