  ...
  return (
    <span className="relative inline-flex">
      <button
        ...
        className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[11px] font-medium bg-amber-500/10 text-amber-300 hover:bg-amber-500/20 hover:text-amber-200 transition-colors border border-amber-500/20 cursor-pointer"
      ...
      {open && (
        <div className="absolute bottom-full left-0 mb-1.5 z-30 w-64 p-3 rounded-xl bg-zinc-800/95 backdrop-blur-xl border border-zinc-700/50 shadow-lg">
          ...
          <a
            ...
            className="text-[11px] text-amber-400 hover:text-amber-300 truncate block hover:underline"
          >
            {url}
          </a>
