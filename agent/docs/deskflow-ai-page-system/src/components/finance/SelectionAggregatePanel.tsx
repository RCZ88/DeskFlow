...
import { Trash2, Tag, Download, X, Handshake } from 'lucide-react'
...
export function SelectionAggregatePanel(props: Props) {
  const { open, data, currency, busy, onClear, onDelete, onRecategorize, onExport, onSetFollowThrough } = props
