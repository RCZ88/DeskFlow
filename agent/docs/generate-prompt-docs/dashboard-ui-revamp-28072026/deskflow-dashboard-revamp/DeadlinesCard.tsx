// ============================================================
// DeskFlow Dashboard — DeadlinesCard (Revamped)
// Skills: Frontend Design (urgency color system, glass),
//         Human-Centric UX (progressive disclosure, confirmation),
//         Motion (L2 — hover lift, stagger, layout animations),
//         MCP (GlareHover, NumberTicker, BorderBeam, AnimatedShinyText)
// ============================================================
...
export function DeadlinesCard({
  ...
  const urgentCount = useMemo(() =>
    sortedPending.filter(d => getDaysUntil(d.due_date) <= 2).length,
    [sortedPending]
  );
          ...
          <motion.div variants={formVariants} initial="hidden" animate="show" exit="exit" className="overflow-hidden">
            <div className="p-3 rounded-lg bg-zinc-900/60 border border-zinc-800/50 space-y-2.5 mb-3">
              <Input
                ...
                autoFocus
                className="bg-zinc-900/80 border-zinc-700/50 focus-visible:ring-rose-500/50 text-[13px]"
              />
              <Input
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <Popover>
                  <PopoverTrigger asChild>
                    <button className="h-8 px-3 text-xs flex-1 justify-start rounded-md bg-zinc-900/80 border border-zinc-700/50 text-zinc-400 hover:text-white hover:border-zinc-600 transition-colors text-left min-w-[140px]">
              ...
              <div className="flex items-center gap-2">
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button size="sm" onClick={handleAdd} className="bg-rose-500/20 text-rose-300 border border-rose-500/30 hover:bg-rose-500/30 text-[12px]">
            ...
            if (isEditing) {
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                      <Button size="sm" onClick={saveEdit} className="bg-rose-500/20 text-rose-300 border border-rose-500/30 hover:bg-rose-500/30 text-[12px]">
                        Save
                      </Button>
                    </motion.div>
                    <Button size="sm" variant="ghost" onClick={() => { setEditingId(null); setEditForm({}); setEditDate(undefined); }} className="text-zinc-400 hover:text-white text-[12px]">
                      Cancel
                    </Button>
                  </div>
                </motion.div>
            ...
            return (
              ...
              >
                <GlareHover
                  ...
                  color={meta.color}
                  opacity={urgency === 'normal' ? 0.1 : 0.25}
                  angle={-45}
                  duration={500}
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          ...
                          <motion.button
                            ...
                            title={deleteConfirmId === dl.id ? 'Click again to confirm' : 'Delete'}
                          >
                            <Trash2 size={12} />
                          </motion.button>
                        </div>
        ...
        <div className="mt-3 pt-3 border-t border-zinc-800/50 shrink-0">
          ...
          >
            ...
            <span className="ml-auto text-emerald-400">
              <NumberTicker value={completed.length} delay={200} duration={600} />
            </span>
          </button>
