// ============================================================
// DeskFlow Dashboard — GoalsCard (Revamped)
// Skills: Frontend Design (glass, motion, typography),
//         Human-Centric UX (empty states, forgiveness, feedback),
//         Motion (L2 Responsive — stagger, hover lift, confetti),
//         MCP (GlareHover, NumberTicker, BorderBeam, Confetti,
//               AnimatedShinyText, AnimatedGradientText)
// ============================================================
          ...
          <motion.div variants={formVariants} initial="hidden" animate="show" exit="exit" className="overflow-hidden">
            <div className="p-3 rounded-lg bg-zinc-900/60 border border-zinc-800/50 space-y-2.5 mb-3">
              <Input
                ...
                autoFocus
                className="bg-zinc-900/80 border-zinc-700/50 focus-visible:ring-violet-500/50 text-[13px]"
              />
              <Input
                ...
                {newGoal.targetType === 'time' && (
                  ...
                  >
                    ...
                    <Input
                      ...
                      className="w-16 bg-zinc-900/80 border-zinc-700/50 text-[13px]"
                    />
              ...
              {longTermGoals.length > 0 && (
                <Select
                  ...
                  onValueChange={v => setNewGoal(p => ({ ...p, parentId: v }))}
                  className="w-full"
                >
              ...
              <div className="flex items-center gap-2 pt-1">
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button size="sm" onClick={handleAdd} className="bg-violet-500/20 text-violet-300 border border-violet-500/30 hover:bg-violet-500/30 text-[12px]">
                    <Plus size={12} className="mr-1" /> Add Goal
                  </Button>
                </motion.div>
                <Button size="sm" variant="ghost" onClick={() => { resetAddForm(); setIsAdding(false); }} className="text-zinc-400 hover:text-white text-[12px]">
                  Cancel
                </Button>
              </div>
            </div>
          ...
          <motion.div variants={formVariants} initial="hidden" animate="show" exit="exit" className="overflow-hidden">
            <div className="p-3 rounded-lg bg-violet-500/[0.04] border border-violet-500/20 mb-3">
              <div className="flex items-center justify-between mb-2">
                ...
                <button onClick={() => setShowSuggestions(false)} className="text-zinc-500 hover:text-zinc-300">
                  <X size={12} />
                </button>
              </div>
                ...
                {suggestions.map((suggestion, i) => (
                  ...
                  >
                    <GlareHover
                      ...
                      duration={600}
                    >
                      <div className="flex items-center justify-between p-2.5 rounded-md w-full">
            ...
            >
              {editingId === goal.id ? (
                ...
                <div className="p-3 rounded-lg bg-zinc-900/60 border border-zinc-800/50 space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                      <Button size="sm" onClick={saveEdit} className="bg-violet-500/20 text-violet-300 border border-violet-500/30 hover:bg-violet-500/30 text-[12px]">
                        Save
                      </Button>
                    </motion.div>
                    <Button size="sm" variant="ghost" onClick={() => { setEditingId(null); setEditForm({}); }} className="text-zinc-400 hover:text-white text-[12px]">
                      Cancel
                    </Button>
                  </div>
                </div>
                ...
                <GlareHover
                  ...
                  angle={-45}
                  duration={500}
                  className="rounded-lg border transition-all duration-200 border-zinc-800/30 hover:border-zinc-700/40"
                >
                  <div className="flex items-start gap-3 p-3 w-full">
                    ...
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
                      ...
                      <motion.button
                        ...
                        title={deleteConfirmId === goal.id ? 'Click again to confirm' : 'Delete'}
                      >
                        <Trash2 size={12} />
                      </motion.button>
                    </div>
