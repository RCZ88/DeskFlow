...
export function ContextSummaryCard({ unfinishedCount, completedThisWeek, weeklyTotal = Math.max(completedThisWeek, 5), loading, error, updatedAt = Date.now(), onRefresh }: ContextSummaryCardProps) {
