    ...
    <GlassCard accent="emerald">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-amber-500/10 ring-1 ring-amber-500/15 flex items-center justify-center">
            <Flag className="w-3.5 h-3.5 text-amber-400" />
          </div>
          <div>
            <h3 className="text-sm font-semibold text-zinc-100">Long-term Plan</h3>
            {!loading && (
      ...
      {!loading && error && (
        <div className="rounded-lg bg-red-500/8 ring-1 ring-red-500/15 p-3 text-xs text-red-400 mb-2">{error}</div>
      )}
      ...
      {!loading && (mode === 'manual' ? (
          ...
          >
            ...
            {/* Completed section */}
            {done.length > 0 && (
              <div className="mt-4 pt-3 ring-0 border-t border-zinc-800/60">
                <button
