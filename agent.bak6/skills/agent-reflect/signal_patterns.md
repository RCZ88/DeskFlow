...
When implementing signal detection:

1. Parse conversation messages chronologically
2. Apply pattern matching to each message
3. Group signals by category and confidence
4. Deduplicate similar signals
