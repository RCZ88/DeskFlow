  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: "space-x-1 flex items-center absolute top-1 left-1 right-1 justify-between",
        nav_button: cn(
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-zinc-800 hover:text-white text-zinc-300"
        ),
