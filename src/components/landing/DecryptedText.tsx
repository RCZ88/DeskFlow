...
// LAMINAR restyle of React Bits' DecryptedText (real logic preserved).
// Monochrome: revealed glyphs = --text-hi; scrambling glyphs = --text-lo (white alpha).
...
export default function DecryptedText({
  ...
  className = "text-[var(--text-hi)]",
  parentClassName = "",
  encryptedClassName = "text-[var(--text-lo)]",
  animateOn = "hover",
  ...props
}: DecryptedTextProps) {
  ...
  useEffect(() => {
    ...
    const obs = new IntersectionObserver(cb, { root: null, rootMargin: "0px", threshold: 0.1 });
