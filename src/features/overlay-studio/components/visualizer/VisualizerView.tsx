...
import { FileJson, Layers, Play } from 'lucide-react'
    ...
    <div className="flex flex-col h-full p-5 gap-4">
      ...
      <div className="flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-2">
          <button onClick={() => dispatch({ type: 'TOGGLE_SAFE_ZONES' })} className={`studio-btn rounded-lg text-[11px] px-3 py-1.5 transition-colors ${state.ui.showSafeZones ? 'bg-cyan-500/15 text-cyan-400 border border-cyan-500/30' : 'bg-zinc-800/50 text-zinc-500 border border-zinc-700/30'}`}>Safe Zones</button>
